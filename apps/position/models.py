...
class PositionOri(models.Model):
    ...
    detail_url = models.CharField("详情链接", max_length=100, null=True)
    ...
    position_skill = models.CharField("职位技能", max_length=100, null=True)
    position_description = models.TextField("岗位描述", null=True)
    position_welfare = models.CharField("职位福利", max_length=100, null=True)
    position_location = models.CharField("工作地点", max_length=100, null=True)
